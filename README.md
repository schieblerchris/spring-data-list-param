...
### Spring 2.7.16
```
java.lang.NullPointerException: Cannot invoke "org.hibernate.hql.internal.ast.tree.SelectExpression.getDataType()" because the return value of "org.hibernate.hql.internal.ast.tree.SelectClause.getFirstSelectExpression()" is null

	at org.hibernate.hql.internal.ast.tree.QueryNode.getDataType(QueryNode.java:151)
	at org.hibernate.hql.internal.ast.tree.AbstractNullnessCheckNode.extractDataType(AbstractNullnessCheckNode.java:95)
	at org.hibernate.hql.internal.ast.tree.AbstractNullnessCheckNode.initialize(AbstractNullnessCheckNode.java:30)
	...
	at jdk.proxy2/jdk.proxy2.$Proxy113.findAllByCountryInOrCountriesParameterIsNullOrderSwitched(Unknown Source)
	at com.github.schieblerchris.playground.spring.datalistparam.CityRepositoryTest.findAllByCountryInOrCountriesIsNullOrderSwitched_EmptyCountry(CityRepositoryTest.java:73)
...
### Spring 3.1.3
This version seems to be really broken (mentioned in Release-Notes: https://github.com/spring-projects/spring-data-jpa/releases/tag/3.1.4)
```
